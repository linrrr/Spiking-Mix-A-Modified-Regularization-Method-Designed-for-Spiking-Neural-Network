...
<br>This model still uses the LIF model [SpikingJelly: An open-source machine learning infrastructure platform for spike-based intelligence](https://github.com/fangwei123456/spikingjelly) 
<br> to accumulate the membrane voltage.
